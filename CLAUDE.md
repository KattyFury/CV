...
When starting a new project, automatically create 2 files in the root:

- **`MEMORY.md`** — log important decisions  
  Format: `- [date]: [decision] — reason: [why]`

- **`ERRORS.md`** — log approaches that failed  
  Format: `- [date]: Tried [approach] → failed because [reason] → switched to [alternative]`
